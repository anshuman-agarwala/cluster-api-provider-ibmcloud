...
func (in *IBMPowerVSClusterSpec) DeepCopyInto(out *IBMPowerVSClusterSpec) {
	*out = *in
	...
	if in.Workspaces != nil {
		...
		*out = make([]PowerVSWorkspace, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PowerVSWorkspace) DeepCopyInto(out *PowerVSWorkspace) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
	...
	in.DHCPNetwork.DeepCopyInto(&out.DHCPNetwork)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PowerVSWorkspace.
func (in *PowerVSWorkspace) DeepCopy() *PowerVSWorkspace {
	if in == nil {
		return nil
	}
	out := new(PowerVSWorkspace)
	in.DeepCopyInto(out)
	return out
}
